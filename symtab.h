...
#ifndef SEMANTIC_SYMTAB_H
#define SEMANTIC_SYMTAB_H
...
typedef struct _bucket {
    ...
    int lineno;
    int ivalue;
    // For local variables, the offset in relative to ebp,
...
/* create a new symble table SymTable.ID increments each time this function is called */
SymTable *symNew(SymTable *parent);

/* look up a symbol */
Symbol *symLookup(SymTable *table, char *name);

/* insert a symbol into the provided symbol table */
Symbol *symInsert(SymTable *table, char *name);

/* destroy all memory blocks for the symTable */
void symDestroy(SymTable *table);

void symDelete(SymTable *table, char *name);

/*
 * CRC32 table from crc32.c authored by Gary S. Brown
